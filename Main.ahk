...
seedItems := ["Carrot Seed", "Starwberry Seed", "Blueberry Seed", "Tomato Seed", "Cauliflower Seed", "Watermelon Seed" 
...
Gui, Add, GroupBox, x23 y50 w475 h340 cD3D3D3, Credits
    ...
    Gui, Add, Picture, x40 y70 w48 h48, % mainDir "Images\\Odi.png"
    Gui, Font, s10 cWhite Bold, Segoe UI
    Gui, Add, Text, x100 y70 w200 h24, Odi
    Gui, Font, s8 cFFC0CB Italic, Segoe UI
    Gui, Add, Text, x100 y96 w200 h16, Macro Creator
    Gui, Font, s8 cWhite, Segoe UI
    Gui, Add, Text, x40 y130 w200 h40, Main Developer, OCR, Gui :)
